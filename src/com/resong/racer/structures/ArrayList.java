...
import com.resong.racer.exceptions.ElementNotFoundException;
import com.resong.racer.exceptions.EmptyCollectionException;
...
public class ArrayList<T> implements ListADT<T>, Iterable<T> {
	...
	/******************************************************************
	 * Returns a reference to the element at the front of the list. The element is
	 * not removed from the list. Throws an EmptyCollectionException if the list is
	 * empty.
	 ******************************************************************/
	...
	/******************************************************************
	 * Returns a reference to the element at the rear of the list. The element is
	 * not removed from the list. Throws an EmptyCollectionException if the list is
	 * empty.
	 ******************************************************************/
	...
	/******************************************************************
	 * Creates a new array to store the contents of the list with twice the capacity
	 * of the old one.
	 ******************************************************************/
